"""External interface to the BeautifulSoup HTML parser.
   This script was copied from lxml.html to our goose fork
   because we made some changes to be supported by python 3
"""
...
# this try-exception block will import bs4 if python version is >= 3.0.0
# or BeautifulSoup for older python version
try:
    from bs4 import (
